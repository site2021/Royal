    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <table id="dg" title=" MENÚ'S" class="easyui-datagrid" style="width:100%;height:400px"      
          ...
          <thead>
            <tr>
              <th field="dia" width="150">Día</th>
              <th field="sopa" width="150">Sopa</th>
              <th field="principio" width="150">Principio</th>
              <th field="carne" width="150">Carne</th>      
              <th field="jugo" width="150">Jugo</th>      
              <th field="observacion" width="246">Observación</th>      
              <th field="aprobacion" width="90">Aprobación</th>      
            </tr>
          </thead>
        </table>
        ...
        <div id="dlg" class="easyui-dialog" class="box box-success" closed="true" style="width: 60%">
          ...
          <div class="box-body">
            <label>Día</label>
            <select id="dia" name="dia" class="form-control" placeholder="Seleccione el día">
            ...
            <br/>
            <label>Sopa</label>
            <select id="sopa" name="sopa" class="form-control">
            ...
            <select id="principio" name="principio" class="form-control">
            ...
            <br/>
            <label>Jugos</label>
            <select id="jugo" name="jugo" class="form-control">
