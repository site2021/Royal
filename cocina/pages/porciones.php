  ...
  <body class="skin-green">
    <div class="wrapper">
           ...
           <li class="active treeview">
            ...
            <li>
              <a href="porciones.php">
                <i class="fa fa-cutlery"></i> <span>Porciones</span>
              </a>
            </li>
          </ul>
      ...
      <div class="content-wrapper">
        ...
        <table id="dg" title="MINUTA 2 A 5 AÑOS" class="easyui-datagrid" style="width:100%;height:300px"      
          url="../json/porcion2a5.php"
          toolbar="#toolbar" singleSelect="true">
          <thead>
            <tr>
              <th field="alimento" width="270">Grupo Alimento</th>
              <th field="pbruto" width="270">P. Bruto</th>
              <th field="pneto" width="270">P. Neto</th>
              <th field="udcasera" width="270">Unidad Casera</th>      
            </tr>
          </thead>
        </table>
        <br>
        <table id="dg" title="MINUTA 6 A 12 AÑOS" class="easyui-datagrid" style="width:100%;height:300px"      
          url="../json/porcion6a12.php"
          toolbar="#toolbar" singleSelect="true">
          <thead>
            <tr>
              <th field="alimento" width="270">Grupo Alimento</th>
        ...
        <br>
        <table id="dg" title="MINUTA 13 A 18 AÑOS" class="easyui-datagrid" style="width:100%;height:300px"      
          url="../json/porcion13a18.php"
          toolbar="#toolbar" singleSelect="true">
          <thead>
            <tr>
              <th field="alimento" width="270">Grupo Alimento</th>
