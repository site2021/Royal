...
$sql="SELECT ciudad,estado,foto,nombre FROM tbusuarios WHERE usuario='$usuario'";
$result = mysqli_query($conexion,$sql);

$valoresY = array(); //estatura - ciudad 
$valoresX = array(); //edad - estado

$valoresYPeso = array(); //peso - foto
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="menu.php">
                <i class="fa fa-cutlery"></i> <span>Menu´s</span>
              </a>
            </li>
          </ul>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <!-- <input type="ciudadE" name="ciudadE" <?php echo $ciudadE; ?>> -->
