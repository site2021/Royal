...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Mom's Kitchen | Perfil 04</title>
        ...
        <section class="content-header">
          <h1>
            ...
            <small></small>
              ...
              <table id="dg" title=" MENÚ´S DEL MES" class="easyui-datagrid" style="width:100%;height:400px"      
              url="json/menus_aprobados.php"
