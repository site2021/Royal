...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Mom's Kitchen | Perfil 05</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <div class="box-footer">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editInformacion()">Añadir Información</a>
        ...
        <table id="dg" title="ESTUDIANTES" class="easyui-datagrid" style="width:100%;height:400px"      
          url="json/estudiantes_get.php"
          toolbar="#toolbar" singleSelect="true">
          <thead>
            <tr>
              <th field="nombre" width="420">Nombre</th>
              <th field="edad" width="222">Edad</th>
              <th field="peso" width="222">Peso</th>      
              <th field="estatura" width="222">Estatura</th>     
            </tr>
          </thead>
        </table>
        ...
        <div id="dlg" class="easyui-dialog" class="box box-success" closed="true" style="width: 60%">
          ...
          <div class="box-body">
            ...
            <label>Nombre</label>
            <input id="nombre" name="nombre" class="form-control" disabled></input>
            <br/>
            <label>Edad</label>
            <input id="edad" name="edad" class="form-control"></input>
            <br/>
            <label>Peso</label>
            <input id="peso" name="peso" class="form-control"></input>
            <br/>
            <label>Estatura</label>
            <input id="estatura" name="estatura" class="form-control"></input>
            <br/>
...
<script type="text/javascript">
  ...
  function editInformacion(){
    ...
    if (row){
      ...
      $('#fm').form('load',row);
      url = 'json/estudiantes_update.php?id='+row.id;
    }
  }
