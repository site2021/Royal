...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Mom's Kitchen | Perfil 06</title>
  ...
  <body class="skin-green">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <table id="dg" title="USUARIOS" class="easyui-datagrid" style="width:100%;height:400px"      
          url="json/usuarios_get.php"
          toolbar="#toolbar" singleSelect="true">
          <thead>
            <tr>
              <th field="usuario" width="250">Usuario</th>
              <th field="nombre" width="330">Nombre</th>
              <th field="clave" width="250">Clave</th>
              <th field="perfil" width="250">Perfil</th>     
            </tr>
          </thead>
        </table>
        ...
        <div id="dlg" class="easyui-dialog" class="box box-success" closed="true" style="width: 60%">
          ...
          <div class="box-body">
            ...
            <label>Usuario</label>
            <input id="usuario" name="usuario" class="form-control"></input>
            <br/>
            <label>Nombre</label>
            <input id="nombre" name="nombre" class="form-control"></input>
            <br/>
            <label>Clave</label>
            <input id="clave" name="clave" class="form-control"></input>
            <br/>
            <label>Perfil</label>
            <input id="perfil" name="perfil" class="form-control"></input>
            <br/>
        ...
        <!-- <div id="dlg" class="easyui-dialog"
          closed="true" class="box box-danger">
          <div class="col-md-6">
          <div class="ftitle">Datos USUARIO</div>
          <form id="fm" method="post" novalidate>
            <div class="fitem">
            ...
            <div class="fitem">
              <label>Clave</label>
              <input name="clave" class="easyui-textbox">
            </div>
            <div class="fitem">
              <label>Perfil</label>
            ...
            <div class="fitem">
              ...
              <input name="ejecutivo" class="easyui-textbox" >
            </div>
            <div class="fitem">
              <label>Costos</label>
              <input name="costos" class="easyui-textbox" >
            </div>
            <div class="fitem">
              <label>Descto</label>
              <input name="descto" class="easyui-textbox" >
            </div>
            <div class="fitem">
              <label>Estado</label>
...
<script type="text/javascript">
  ...
  var url;
  function newUsuario(){
    $('#dlg').dialog('open').dialog('setTitle','USUARIO');
    $('#fm').form('clear');
  ...
  function editUsuario(){
    ...
    if (row){
      ...
      $('#fm').form('load',row);
      url = 'json/usuario_update.php?id='+row.id;
    }
  }
  ...
  function destroyUsuario(){
    var row = $('#dg').datagrid('getSelected');
    if (row){
      $.messager.confirm('Confirm','Esta seguro de remover el usuario: ' + row.nombre,function(r){
        if (r){
