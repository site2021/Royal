...
escribir($pdf,30,104,156,7,'Que el señor ' .$xconductor. ' identificado(a) con cédula de ciudadanía No. ' .($xcedula). '; laboró en  la Cooperativa Royal Express como conductor, desde  el ' .$xfechaingreso. ' hasta el ' .$xfecharetiro. '.',1,14,'J','',0,0);

escribir($pdf,30,140,156,7,'Para constancia se firma el ' .$wfecha. ', por solicitud del interesado.',1,14,'J','',0,0);
