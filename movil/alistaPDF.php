...
// marca de agua
$pdf->Image('img/royal001.jpg',15,5,35);
...
escribir($pdf,138,45,100,5,'COOPERATIVA ROYAL EXPRESS ',0,8,'L','B',0,0);
...
escribir($pdf,138,138,100,5,'COOPERATIVA ROYAL EXPRESS ',0,8,'L','B',0,0);
