...
escribir($pdf,30,104,156,7,'Que el señor ' .$xconductor. ' identificado(a) con cédula de ciudadanía No. ' .($xcedula). '; labora con  la Cooperativa Royal Express como conductor, con un contrato laboral a término fijo desde  el ' .$xfechaingreso. '.',1,14,'J','',0,0);

escribir($pdf,30,146,156,7,'Para constancia se firma el ' .$wfecha. ', por solicitud del interesado.',1,14,'J','',0,0);
