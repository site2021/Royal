<?php
    ...
    $consulta = "SELECT codigoencuesta,fechaencuesta,nombreencuesta,entidadencuesta,rutaencuesta,internoencuesta,jornadaencuesta,temperaturacasa,temperaturaaux,tos,malestar,difrespirar,diarrea,olfatogusto,fuerapais,contactosospechoso,cuarentena,personacuarentena,compromiso FROM tbencuestacovid";
    ...
    if($ok == true){
        ...
        $objDrawing->setPath('img/liceoingles.png');
        ...
        while ($fila = mysqli_fetch_array($stmt)) {
            $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('D'.$i,  $fila['entidadencuesta'])
                    ->setCellValue('E'.$i,  $fila['rutaencuesta'])
                    ->setCellValue('F'.$i,  $fila['internoencuesta'])
                    ->setCellValue('G'.$i,  $fila['jornadaencuesta'])
                    ->setCellValue('H'.$i,  $fila['temperaturacasa'])
                    ->setCellValue('I'.$i,  $fila['temperaturaaux'])
        ...
        header('Content-Disposition: attachment;filename="CondSaludLiceo.xlsx"');
