...
$pdf->Image('img/royal001.jpg',145,18,62);
...
escribir($pdf,10,51,194,5,'No. 3660045182020'.$xcontrato.$extracto,0,11,'C','B','0');
...
escribir($pdf,10,70,194,5,'COOPERATIVA MULTIACTIVA DE TRANSPORTES ESPECIALES Y TURISMO ROYAL EXPRESS',0,10,'l','','0');

//N° DE CONTRATO
escribir($pdf,10,77,194,3.5,'NIT:',0,10,'L','B','0');
escribir($pdf,20,77,194,3.5,'891.408.122-6',0,10,'L','','0');
...
$contenido = 'http://intranet.cooperativaroyalexpress.com/app/secciones/fuec/planilla2020.php?extracto='.$extracto.'&contrato='.$xcontrato.'&cedularesponsable='.$xcedularesponsable; //Texto
...
escribir($pdf,10,233,80,6,'Dirección: CRA 24 #11-26 BRR ÁLAMOS Teléfono: 3335401',1,11,'L','','0');
escribir($pdf,10,246,90,6,'Email: servicioalcliente@cooperativaroyalexpress.com',0,11,'L','','0');
...
$pdf->Image('img/firma_jefe.jpg',160,238,42);

$pdf->Image('img/sello.jpg',130,235,31);
