...
$pdf->Image('royal001.jpg',114,18,83);
...
escribir($pdf,10,69,194,5,'COOPERATIVA MULTIACTIVA DE TRANSPORTES ESPECIALES Y TURISMO ROYAL EXPRESS',0,9,'l','','0');
...
$pdf->Image('sello.jpg',135,237,29);
