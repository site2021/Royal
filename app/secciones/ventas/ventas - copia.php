...
<body>
	...
	<div class="botonera">
		<div class="bordes" style="margin-left:50px">
	        ...
	        <div class="tdiv">
	         	<a id="btnGenerarPDF" name="btnGenerarPDF" class="boton" onclick="cotizacionPDF()">
		        ...
		        <form id="frmlinearegistro">
		        	<table>
		        		...
		        		<tr>
							...
							<td>
								<input id="cmbtipovehiculo" name="cmbtipovehiculo" class="easyui-combobox" style="width:150px"
