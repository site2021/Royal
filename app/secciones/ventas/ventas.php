...
<body>
	...
	<div class="botonera">
        ...
        <div class="bordes" style="margin-left:50px">
        	<div class="tdiv">
	         	<a id="btnGenerarPDF" name="btnGenerarPDF" class="boton" onclick="cotizacionPDF(3)">
	         		<img src="icons/Document.png" >
	         	</a>
	         	<span class="tooltiptext">IMPRIMIR planilla (Alt+I)</span>
	        </div>
	        <div class="tdiv">
	         	<a id="btnGenerarPDF" name="btnGenerarPDF" class="boton" onclick="cotizacionPDF(4)">
	         		<img src="icons/Document.png" >
	         	</a>
	         	<span class="tooltiptext">IMPRIMIR planilla (Alt+I)</span>
	        </div>
		        ...
		        <form id="frmlinearegistro">
		        	<table>
		        		...
		        		<tr>
							...
							<td>
								<input id="cmbtipovehiculo" name="cmbtipovehiculo" class="easyui-combobox" style="width:170px"
 	...
 	<script type="text/javascript">
		function cotizacionPDF(pcual){
    		...
    		if(pcual==1){
    			...
    			window.open ("planilla.php?numero="+xnumero+"&usuario="+xusuario, params);
    		}else if(pcual==4){
    			window.open ("planilla2.php?numero="+xnumero+"&usuario="+xusuario, params);
    		}
	...
	<script type="text/javascript">
		...
		function calcularTotal(){
			...
			if(xproducto == '22' && xdestino == 'MARIQUITA LETRAS'){
				$("#robservalinea").textbox('setValue', 'VEHICULO (PEREIRA A MARIQUITA) - (ALTO DE LETRAS-PEREIRA)');
			}
			else if(xproducto == '22' && xdestino == 'BUGA'){
				$("#robservalinea").textbox('setValue', 'VEHICULO (BUGA A PEREIRA) CICLISTAS (PEREIRA A BUGA) CON 3 PARADAS');
			}
			else if(xproducto == '22' && xdestino == 'SALENTO'){
				$("#robservalinea").textbox('setValue', 'VEHICULO (PEREIRA A SALENTO) - (SALENTO A PEREIRA) CICLISTA (SALENTO TROCHA HACIA LA LINEA)');
			}
			else if(xproducto == '22' && xdestino == 'CALIMA' || xdestino == 'CALIMA (2 DIAS)'){
				$("#robservalinea").textbox('setValue', 'VEHICULO (DARIEN-PEREIRA)CICLISTAS (PEREIRA-DARIEN)');
			}
			else if(xproducto == '22' && xdestino == 'CERRO GUALI POR GALLINAZO'){
				$("#robservalinea").textbox('setValue', 'VEHICULO (PEREIRA A LA ENEA) - (BOMBA MALTERIA A PEREIRA) CICLISTA CERRO GUALI');
			}
			else if(xproducto == '22' && xdestino == 'CERRO GUALI'){
				$("#robservalinea").textbox('setValue', 'VEHICULO (PEREIRA A EL 8) -(EL 8 A PEREIRA)CICLISTAS CERRO GUALI');
			}
			else{
				$("#robservalinea").textbox('setValue', '');
			}
