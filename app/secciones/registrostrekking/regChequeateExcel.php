<?php
    ...
    $consulta = "SELECT codigoencuesta,fechaencuesta,nombreencuesta,celular,temperaturaaux,tos,malestar,difrespirar,diarrea,olfatogusto,fuerapais,contactosospechoso,cuarentena,personacuarentena,compromiso,ingreso,horaingreso,salida,horasalida FROM tbtrekkingcovid ORDER BY fechaencuesta DESC";
    ...
    if($ok == true){
        ...
        $objDrawing->setName('Logo');
        $objDrawing->setDescription('Logo');
        $objDrawing->setPath('img/trekking.png');
        $objDrawing->setHeight(36);
