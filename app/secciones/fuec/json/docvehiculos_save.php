...
$sql = "INSERT INTO tbvehiculosimgre(interno,placa,nombredocumento,documentoimg,tipodocumento) VALUES('$interno','$placa','$nombredocumento','$imgDocumento','$tipodocumento')";
