...
$sql = "UPDATE tbconductores SET interno='$interno',conductor='$conductor',cedulaconductor='$cedulaconductor',sexo='$sexo',fechanacimiento='$fechanacimiento',edad='$edad',lugarnacimiento='$lugarnacimiento',estadocivil='$estadocivil',tiposangre='$tiposangre',direccion='$direccion',barrio='$barrio',municipio='$municipio',telefono='$telefono',celular='$celular',categorialicencia='$categorialicencia',vigencialicencia='$vigencialicencia',formacioneducativa='$formacioneducativa',profesion='$profesion',fechaingreso='$fechaingreso',fecharetiro='$fecharetiro',salarioletra='$salarioletra',salarionum='$salarionum' WHERE id=$id";
