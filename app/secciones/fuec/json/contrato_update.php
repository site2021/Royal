...
$sql = "UPDATE tbcontratos SET contrato='$contrato',objetocontrato='$objetocontrato',cliente='$cliente',nit='$nit',responsable='$responsable',cedularesponsable='$cedularesponsable',direccion='$direccion',telefono='$telefono',valorservicio='$valorservicio' WHERE id=$id";
