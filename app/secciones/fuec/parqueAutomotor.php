<?php
 ...
 include '../../control/conex.php';
    ...
    $consulta = "SELECT * FROM tbvehiculos WHERE tipovinculacion!= 'CONVENIO EMPRESARIAL' AND estado!='DESVINCULADO'";
    
    $conautorizada  = "SELECT * FROM tbpqautomotorre WHERE fecharesolucion='$xfecharesolucion' AND estado!='DESVINCULADO'";

    $conmicrobus = "SELECT COUNT(clase) microbus FROM tbvehiculos WHERE clase='MICROBUS' AND tipovinculacion!= 'CONVENIO EMPRESARIAL' AND estado!='DESVINCULADO'";

    $conbus = "SELECT COUNT(clase) bus FROM tbvehiculos WHERE clase='BUS' AND tipovinculacion!= 'CONVENIO EMPRESARIAL' AND estado!='DESVINCULADO'";

    $conbuseta = "SELECT COUNT(clase) buseta FROM tbvehiculos WHERE clase='BUSETA' AND tipovinculacion!= 'CONVENIO EMPRESARIAL' AND estado!='DESVINCULADO'";

    $concamioneta = "SELECT COUNT(clase) duster FROM tbvehiculos WHERE clase='DUSTER' AND tipovinculacion!= 'CONVENIO EMPRESARIAL' AND estado!='DESVINCULADO'";
