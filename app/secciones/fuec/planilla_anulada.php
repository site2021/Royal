...
$pdf->Image('img/marca_anulado.JPG',16,18,195);

//LOGOS
escribir($pdf,10,15,97,28,'',0,0,'','','1');
$pdf->Image('img/minitransporte.jpg',16,18,80);
escribir($pdf,107,15,97,28,'',0,0,'','','1');
$pdf->Image('img/royal001.jpg',122,18,65);

if (strlen($xcontrato) == 1) {
	$xcontrato = "000".$xcontrato;

}else if (strlen($xcontrato) == 2){
	
	$xcontrato = "00".$xcontrato;
}else if (strlen($xcontrato) == 3){
	
	$xcontrato = "0".$xcontrato;
}

if (strlen($extracto) == 1) {
	$extracto = "000".$extracto;

}else if (strlen($extracto) == 2){
	
	$extracto = "00".$extracto;
}else if (strlen($extracto) == 3){
...
$contenido = 'http://intranet.cooperativaroyalexpress.com/app/secciones/fuec/planilla.php?extracto='.$extracto.'&contrato='.$xcontrato.'&cedularesponsable='.$xcedularesponsable; //Texto
...
$pdf->Image('img/sello.jpg',135,239,29);
