...
// punto-1
escribir($pdf,10,$xfila+18,5,5,'1.',0,8,'L','B');
escribir($pdf,15,$xfila+18,190,5,$punto1,1,8,'J','');

// punto-2
escribir($pdf,10,$xfila+29,5,5,'2.',0,8,'L','B');
escribir($pdf,15,$xfila+29,190,5,$punto2,1,8,'J','');

// punto-3
escribir($pdf,10,$xfila+39,5,5,'3.',0,8,'L','B');
escribir($pdf,15,$xfila+39,190,5,'El pago de la mensualidad se realizará dentro de los cinco (5) primeros días de cada mes, si hasta el sexto (6) día no se ha cancelado el transporte del estudiante, la empresa no lo transportará y el padre de familia se hará responsable del traslado de su hijo (a) al colegio; sin perjuicio del pago completo del mes respectivo. (El banco, el número de cuenta y el codigo para pago; serán suministrados por la empresa). El servicio de transporte para Sector Rural Metropolitano de Pereira y Dosquebradas se analizará de acuerdo a la ubicación del predio y la firma de esta solicitud no obliga a la empresa a transportar el estudiante.',1,8,'J','');
...
escribir($pdf,15,$xfila+41,190,5,'Con la firma del presente contrato de Transporte, el Padre de Familia y/o Acudiente se compromete a tomar este servicio de transporte por SEIS (6) meses, de febrero a junio y a partir de este momento queda confirmado el contrato de transporte entre el padre de familia y la empresa transportadora.',1,8,'J','');
...
escribir($pdf,15,$xfila+96,190,5,$punto15,1,8,'J','');
