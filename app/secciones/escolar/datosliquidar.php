	...
	<script type="text/javascript">
 	...
 	<script type="text/javascript">
 		...
 		function nuevoRegistro(){
 			...
 			var xcampos = ['colegio','codigo','fechapago','nombre','recorrido','ruta','grado','tarifabl','pago','diferencia',
 						   'observacion','mes','estado'];
 			var xvalores = [xcolegio,xcodigo,xfecha,xnombre,xrecorrido,xruta,xgrado,xtarifa,xpago,xdiferencia,
 							xobservacion,xmes,'X'];
 	...
 	<script type="text/javascript">
		...
		function excelMorosos(){
			...
			if(xmes=='*'){
				location.assign("morososTodos.php?colegio="+xcolegio+"&mes="+xmes);
				return;
			}
