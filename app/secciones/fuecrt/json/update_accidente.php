...
$sql = "UPDATE tbaccidentesrt SET fecha='$fecha',conductor='$conductor',cedulaconductor='$cedulaconductor',seccion='$seccion',tipocontrato='$tipocontrato',cargo='$cargo',tipo='$tipo',descripcion='$descripcion',diasperdidos='$diasperdidos',tipolesion='$tipolesion',parteafectada='$parteafectada',agentelesion='$agentelesion',tipoaccidente='$tipoaccidente',investigado='$investigado',enviadoarl='$enviadoarl',causainmediata='$causainmediata',causabasica='$causabasica',accionimplementar='$accionimplementar',fechaejecucion='$fechaejecucion',responsable='$responsable',fechaseguimiento='$fechaseguimiento',observacion='$observacion' WHERE id=$id";
