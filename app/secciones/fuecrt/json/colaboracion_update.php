...
$sql = "UPDATE tbcolaboracionemprt SET empresa='$empresa',sigla='$sigla',tipoempresa='$tipoempresa',documentoempresa='$documentoempresa',departamento='$departamento',ciudad='$ciudad',direccion='$direccion',telefono='$telefono',correo='$correo',reprlegal='$reprlegal',tiporepr='$tiporepr',documentorepr='$documentorepr',cooperacion='$cooperacion',iniciovigencia='$iniciovigencia',finvigencia='$finvigencia' WHERE id=$id";
