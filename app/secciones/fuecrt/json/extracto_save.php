...
$fecharealizado = htmlspecialchars($_REQUEST['fecharealizado']);
...
$sql = "INSERT INTO tbextractosrt(extracto,contrato,placa,modelo,marca,clase,interno,tarjetaoperacion,cliente,nit,responsable,cedularesponsable,direccion,telefono,modalidad,empresaafiliadora,fechainicio,fechafin,origen,destino,objetocontrato,conductor1,cedulaconductor1,vigencialicencia1,conductor2,cedulaconductor2,vigencialicencia2,conductor3,cedulaconductor3,vigencialicencia3,usuario,cancelado,fechacancelado,fecharealizado,tipoextracto,valorextracto,valorservturis)
