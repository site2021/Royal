...
$rs = mysqli_query($conexion, "SELECT * FROM tbcontradigitalrt WHERE iniciocontrato='$xiniciocontrato' AND fincontrato='$xfincontrato' AND nit='$xnit'");
...
//LOGO
$pdf->Image('img/royaltour.jpg',75,1,62);
