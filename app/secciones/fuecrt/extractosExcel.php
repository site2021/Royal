    ...
    if($ok == true){
        ...
        while ($fila = mysqli_fetch_array($stmt)) {
            $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('AF'.$i,  $fila['usuario'])
                    ->setCellValue('AG'.$i,  $fila['fecharealizado']);
                    $i++;
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A1:AG2')->applyFromArray($estiloTituloReporte);
        $objPHPExcel->getActiveSheet()->getStyle('A4:AG4')->applyFromArray($estiloTituloColumnas);      
        $objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, "A5:AG".($i-1));
