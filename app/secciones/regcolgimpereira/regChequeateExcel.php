<?php
    ...
    $consulta = "SELECT codigoencuesta,fechaencuesta,nombreencuesta,celular,temperaturaaux,tos,malestar,difrespirar,diarrea,olfatogusto,fuerapais,contactosospechoso,cuarentena,personacuarentena,compromiso,ingreso,horaingreso,salida,horasalida FROM tbcolegiogimpereira ORDER BY fechaencuesta DESC";
