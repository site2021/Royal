<?
	...
	$sqlc = mysqli_query($conexion, "SELECT * from tbusuarios where usuario='$usuario'");
	...
	<body>
		<div class="bordesRG">
			...
			<div style="display:none">
				...
				<input id="xbase" name="xbase" class="textbox" value="">
				 		...
				 		<tr style="height:20%">
				 			<td style="width:25%">
				 				<div style="margin-left:5px">
				 					<img id="imagen" src='images/royal001.jpg' style='width:160px;height:65px' alt='[]' onclick="logo()"/>
				 				</div>			 				
				 			</td>
				 			<td style="width:75%">
			...
			<div id="pldatos" class="easyui-panel" title='<font color="white">DATOS</font>' 
				...
				<div style="float:left">
					<label><b>&Uacute;ltima actualizaci&oacute;n: 2017-09-06</b></label>
				</div>
		...
		<script type="text/javascript">
			function logo(){
				if(verlogo==1){
					...
					document.getElementById('imagen').src='images/royal001.jpg';
					verlogo=1;	
				}
					...
					$.post('tablaOracle.php', {tabla:value},				
					  function(result){
						if (result.success){
							...
							// cual base oracle, mysql
							$("#xbase").val(result.xdb);
		...
		<script type="text/javascript">
			...
			function generarColumnas(){
				...
				var xurl='columnas_safix.php?xdb='+xdb+'&tabla='+xtabla+'&columnas='+xcolumnas+'&filtros='+xfiltros;
				//alert(xurl);
		...
		<script type="text/javascript">
			function generarDgDatos(){
				...
				*/
				...
				// variable de control para definir la db
				var xdb = $("#xbase").val();

				var xurl = "columnas_sql_safix.php?xdb="+xdb+"&tabla="+xtabla+"&campos="+xcampos+"&columnas="+xcolumnas+"&ncolumnas="+xncolumnas+
						   "&filtros="+xfiltros+"&valores="+xvalores+'&listaValores='+xlistaValores;
		...
		<script type="text/javascript">
			function generarExcel(){
				...
				var xurl = "reporteExcel.php?xdb="+xbase+"&tabla="+xtabla+"&campos="+xcampos+"&columnas="+xcolumnas+"&ncolumnas="+xncolumnas+"&filtros="+xfiltros+"&valores="+xvalores+'&listaValores='+xlistaValores;
