...
/*
    $conexion = new mysqli('localhost','root','hector','ryl',3306);
...
*/
	...
	$sql = "SELECT numero, conductor valor FROM tbdatosventas";
	...
	//if($resultado->num_rows > 0 ){
		...
		$tituloReporte = "REPORTE PRUEBA";
		$titulosColumnas = array('numero','valor');
