<?php
 ...
 include '../../control/conex.php';
    ...
    $consulta = "SELECT * FROM tbvehiculosg3 WHERE tipovinculacion!= 'CONVENIO EMPRESARIAL' ";
    
    $conautorizada  = "SELECT * FROM tbpqautomotorg3 WHERE fecharesolucion='$xfecharesolucion'";

    $conmicrobus = "SELECT COUNT(clase) microbus FROM tbvehiculosg3 WHERE clase='MICROBUS' AND tipovinculacion!= 'CONVENIO EMPRESARIAL'";

    $conbus = "SELECT COUNT(clase) bus FROM tbvehiculosg3 WHERE clase='BUS' AND tipovinculacion!= 'CONVENIO EMPRESARIAL'";

    $conbuseta = "SELECT COUNT(clase) buseta FROM tbvehiculosg3 WHERE clase='BUSETA' AND tipovinculacion!= 'CONVENIO EMPRESARIAL'";

    $concamioneta = "SELECT COUNT(clase) duster FROM tbvehiculosg3 WHERE clase='DUSTER' AND tipovinculacion!= 'CONVENIO EMPRESARIAL'";
