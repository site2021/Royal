<?php
 ...
 include '../../control/conex.php';
    ...
    if($ok == true){
        ...
        $titulosColumnas = array('FECHA EXPEDICIÓN', 'EXTRACTO', 'CONTRATO', 'INTERNO', 'PLACA', 'CONDUCTOR','ESTADO', 'FECHA CANCELADO', 'TIPO EXTRACTO', 'VALOR', 'VALOR (FONTUR)', 'USUARIO');
        ...
        header('Content-Disposition: attachment;filename="ArqueoCajaExtrac.xlsx"');
