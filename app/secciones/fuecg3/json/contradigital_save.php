...
$sql = "INSERT INTO tbcontradigitalg3(objetocontrato,iniciocontrato,fincontrato,cliente,nit,ciudadcliente,responsable,cedularesponsable,direccion,telefono,ciudadsalida,recorrido,internoveh,placaveh,claseveh,valorservicio,formapago)
		VALUES('$objetocontrato','$iniciocontrato','$fincontrato','$cliente','$nit','$ciudadcliente','$responsable','$cedularesponsable','$direccion','$telefono','$ciudadsalida','$recorrido','$internoveh','$placaveh','$claseveh','$valorservicio','$formapago')";
