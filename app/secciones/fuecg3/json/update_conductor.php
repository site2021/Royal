...
$sql = "UPDATE tbconductoresrt SET interno='$interno',conductor='$conductor',cedulaconductor='$cedulaconductor',sexo='$sexo',fechanacimiento='$fechanacimiento',edad='$edad',lugarnacimiento='$lugarnacimiento',estadocivil='$estadocivil',tiposangre='$tiposangre',direccion='$direccion',barrio='$barrio',municipio='$municipio',telefono='$telefono',celular='$celular',categorialicencia='$categorialicencia',vigencialicencia='$vigencialicencia',formacioneducativa='$formacioneducativa',profesion='$profesion',salarioletra='$salarioletra',salarionum='$salarionum',estadoconductor='$estadoconductor',tipoconductor='$tipoconductor',pasadojudicial='$pasadojudicial',simit='$simit',runt='$runt',contrato='$contrato',examenruta='$examenruta',psicosensometrico='$psicosensometrico',hojavida='$hojavida',induccion='$induccion',ocupacionalingreso='$ocupacionalingreso',ocupacionalretiro='$ocupacionalretiro',eps='$eps',fondopension='$fondopension',cesantias='$cesantias',clase='$clase',seccion='$seccion',tipocontrato='$tipocontrato',cargo='$cargo' WHERE id=$id";
