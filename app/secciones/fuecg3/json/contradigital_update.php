...
$sql = "UPDATE tbcontradigitalg3 SET objetocontrato='$objetocontrato',iniciocontrato='$iniciocontrato',fincontrato='$fincontrato',cliente='$cliente',nit='$nit',ciudadcliente='$ciudadcliente',responsable='$responsable',cedularesponsable='$cedularesponsable',direccion='$direccion',telefono='$telefono',ciudadsalida='$ciudadsalida',recorrido='$recorrido',internoveh='$internoveh',placaveh='$placaveh',claseveh='$claseveh',valorservicio='$valorservicio',formapago='$formapago' WHERE id=$id";
