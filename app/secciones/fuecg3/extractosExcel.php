<?php
 ...
 include '../../control/conex.php';
    ...
    $consulta = "SELECT * FROM tbextractosg3";
    ...
    if($ok == true){
        ...
        while ($fila = mysqli_fetch_array($stmt)) {
            $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('U'.$i,  $fila['objetocontrato'])
                    ->setCellValue('V'.$i,  $fila['conductor1'])
                    ->setCellValue('W'.$i,  $fila['cedulaconductor1'])
                    ->setCellValue('X'.$i,  $fila['vigencialicencia1'])
                    ->setCellValue('Y'.$i,  $fila['conductor2'])
                    ->setCellValue('Z'.$i,  $fila['cedulaconductor2'])
                    ->setCellValue('AA'.$i,  $fila['vigencialicencia2'])
                    ->setCellValue('AB'.$i,  $fila['conductor3'])
                    ->setCellValue('AC'.$i,  $fila['cedulaconductor3'])
                    ->setCellValue('AD'.$i,  $fila['vigencialicencia3']);
                    $i++;
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A1:AD2')->applyFromArray($estiloTituloReporte);
        $objPHPExcel->getActiveSheet()->getStyle('A4:AD4')->applyFromArray($estiloTituloColumnas);      
        $objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, "A5:AD".($i-1));

        // formato numerico para los columnas de datos
        $objPHPExcel->getActiveSheet()->getStyle('F5:AD'.$i)->getNumberFormat()
        ->setFormatCode('#,###');
