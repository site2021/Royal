...
<body>
	...
	<div class="botonera">
	    ...
	    <div class="bordes" style="margin-left:10px">
	        <div class="tdiv">
	         	<a id="btnNewVehiculo" name="btnNewVehiculo" class="boton" onclick="newContrato()">
	         		<img src="icons/Plus.png" >
	         	</a>
	         	<span class="tooltiptext">Nuevo Contrato</span>
	        </div>

	        <div class="tdiv">
	         	<a id="btnEditVehiculo" name="btnEditVehiculo" class="boton" onclick="editContrato()">
	        ...
	        <div class="tdiv">
	         	<a id="btnDestroyVehiculo" name="btnDestroyVehiculo" class="boton" onclick="destroyContrato()">
	        ...
	        <div class="tdiv">
	         	<a id="btnNewExtracto" name="btnNewExtracto" class="boton" onclick="newExtracto()">
	         		<img src="icons/Document.png" >
	         	</a>
	         	<span class="tooltiptext">Nuevo Extracto</span>
	        </div>

	        <div class="tdiv">
	         	<a id="btnDestroyVehiculo" name="btnDestroyVehiculo" class="boton" onclick="newDocumentos()">
	         		<img src="icons/Alarme.png" >
	         	</a>
	         	<span class="tooltiptext">documentos Contrato</span>
	        </div>
	    </div>
	</div>

	<table id="dg" title=" CONTRATOS " class="easyui-datagrid" style="width:100%;height:450px;margin-top:50px;"
		...
		<thead>
			<tr>
				...
				<th field="iniciocontrato" width="150">Fecha Inicio</th>
				<th field="fincontrato" width="150">Fecha Fin</th>
			</tr>
		</thead>
	</table>
		...
		<form id="fmExtracto" method="post" novalidate>
			...
			<div class="fitem">
				...
				<input id="interno" name="interno" class="easyui-combobox" 
					url="json/combointernos.php" style="width:204px"
	...
	<script type="text/javascript">
		...
		function viewdo(){
			...
			if (row){
				...
				window.open("json/document_view.php?id="+row.id, params);
			}
		}
	...
	<script type="text/javascript">
		...
		function traerDatosInterno(xinterno, xplaca){
			var xinterno = $("#interno").combobox('getValue');
		...
		function valorExtracto(xtipoextracto){
			var xtipoextracto = $("#tipoextracto").combobox('getValue');	

			if(xtipoextracto == 'CONTRATO'){
				$("#valorextracto").numberbox("setValue",'6000');
			}
			else{
				$("#valorextracto").numberbox("setValue",'0');			}
		}
	</script>
