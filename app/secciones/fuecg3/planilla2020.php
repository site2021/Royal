...
$rs = mysqli_query($conexion, "SELECT * FROM tbextractosg3 WHERE extracto='$extracto' AND contrato='$xcontrato' AND cedularesponsable='$xcedularesponsable'");
...
$pdf->Image('img/g3logo.jpg',145,11,62);
...
escribir($pdf,10,51,194,5,'No. 3660043182020'.$xcontrato.$extracto,0,11,'C','B','0');
...
escribir($pdf,10,70,194,5,'G3 TRAVEL S.A.S.',0,10,'l','','0');

//N° DE CONTRATO
escribir($pdf,10,77,194,3.5,'NIT:',0,10,'L','B','0');
escribir($pdf,20,77,194,3.5,'900.854.429',0,10,'L','','0');
...
escribir($pdf,10,233,110,6,'AVENIDA SUR #50-03 PASEO LA CASTELLANA LOCAL 36 Teléfono: 3279959',1,11,'L','','0');
escribir($pdf,10,246,90,6,'Email: g3travelsas@gmail.com',0,11,'L','','0');
...
$pdf->Image('img/g3logo.jpg',130,238,31);
