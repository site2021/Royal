...
include 'contratodig-textos.php';

$rs = mysqli_query($conexion, "SELECT * FROM tbcontradigitalg3 WHERE iniciocontrato='$xiniciocontrato' AND fincontrato='$xfincontrato' AND nit='$xnit'");
...
//LOGO
$pdf->Image('img/g3logo.jpg',75,1,62);
...
escribir($pdf,10,213,120,5,'Para constacia se firma en Pereira, a los ____ días del mes de ________ del año 20____.',0,9,'L','','0');
...
escribir($pdf,10,243,44,4,'CARLOS ANDRES RINCON C.C. 10.032.993 REPRESENTANTE LEGAL ROYAL TOUR PLUS S.A.S.',1,9,'L','B','0');
