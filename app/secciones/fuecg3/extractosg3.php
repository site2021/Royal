...
<body>
	<!-- <div id="toolbar">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="planillaPDF(1)">Planilla</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="printExtractos()">Excel Planillas</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-script" plain="true" onclick="printCaja()">Arqueo Caja</a>
	</div> -->
	...
	<div class="botonera">
	    ...
	    <div class="bordes" style="margin-left:10px">
	        <div class="tdiv">
	         	<a id="btnEditExtracto" name="btnEditExtracto" class="boton" onclick="editExtracto()">
	         		<img src="icons/Write2.png" >
	         	</a>
	         	<span class="tooltiptext">Editar Extracto</span>
	        </div>

	        <div class="tdiv">
	         	<a id="btnDestroyExtracto" name="btnDestroyExtracto" class="boton" onclick="destroyExtracto()">
	         		<img src="icons/Trash.png" >
	         	</a>
	         	<span class="tooltiptext">Remover Extracto</span>
	        </div>

	        <div class="tdiv">
	         	<a id="btnExtracto" name="btnExtracto" class="boton" onclick="planillaPDF(1)">
	         		<img src="icons/Document.png" >
	         	</a>
	         	<span class="tooltiptext">Extracto</span>
	        </div>

	        <div class="tdiv">
	         	<a id="btnExcelExtracto" name="btnExcelExtracto" class="boton" onclick="printExtractos()">
	         		<img src="icons/Excel30.png" >
	         	</a>
	         	<span class="tooltiptext">Excel Extractos</span>
	        </div>

	        <div class="tdiv">
	         	<a id="btnArqueoCaja" name="btnArqueoCaja" class="boton" onclick="printCaja()">
	         		<img src="icons/Currency Dollar.png" >
	         	</a>
	         	<span class="tooltiptext">Arqueo de Caja</span>
	        </div>

	        <div class="tdiv">
	         	<a id="btnFontur" name="btnFontur" class="boton" onclick="printFontur()">
	         		<img src="icons/Percent.png" >
	         	</a>
	         	<span class="tooltiptext">Fontur</span>
	        </div>
	    </div>
	</div>

	<table id="dg" title=" EXTRACTOS " class="easyui-datagrid" style="width:100%;height:450px;margin-top:50px;"
			url="json/extractos_get.php"
			headerCls="hc"
			toolbar="#toolbar"
			rownumbers="true" fitColumns="false" singleSelect="true">
		<thead>
			<tr>
				<th field="extracto">Extracto</th>
				<th field="contrato">Contrato</th>
				<th field="cliente" width="400px">Cliente</th>
				<th field="placa">Placa</th>
				<th field="interno">Interno</th>
				<th field="fechainicio">Fecha Inicio</th>				
				<th field="fechafin">Fecha Fin</th>
				<th field="cancelado" width="100px">Cancelado</th>
				<th field="tipoextracto" width="120px">Tipo</th>
				<th field="fechacancelado" width="120px">Fecha Pago</th>
				<th field="usuario" width="124px">Usuario</th>
			</tr>
		</thead>
	</table>
	
	<div id="dlg" class="easyui-dialog" data-options="modal:true" style="width:780px;height:520px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
