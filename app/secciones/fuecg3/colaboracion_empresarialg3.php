	...
	<div id="dlg" class="easyui-dialog" data-options="modal:true" style="width:760px;height:554px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				...
				<input name="iniciovigencia" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser">

				<label>Fin Vigencia:</label>
				<input name="finvigencia" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser">
			</div>
